...
public final class Constants {
	public static String status = "idle"; // "idle" | "autonomous" | "teleop"

	public static final class LifterConstants {

		public static final double kSetPointTop = 0.6;
		public static final double kSetPointBot = 0.3;

		public static final int kLiftChannel = 14;
	...
	public static final class ModuleConstants {
		...
		public static final double kDrivePositionConversionFactor = kDriveMotorGearRatio * kWheelDiameterMeters
				* Math.PI;
	...
	public static final class AutoConstants {
		...
		public static final double kDXController = 0.000010; // PID for making the speed perfect at 1.2 meters per
																// second (max)
		public static final double kDYController = 0.000009; // PID for making the speed perfect at 1.2 meters per
																// second (max)
		...
		public static PIDController thetaController = new PIDController(AutoConstants.kPThetaController, 0,
				kDThetaController);
		 ...
		 */
		// public static final PIDTester xControllTester = new PIDTester(xController,
		// "xController", AutoConstants.kPXController, 0, 0);
		// public static final PIDTester yControllTester = new PIDTester(yController,
		// "yController", AutoConstants.kPYController, 0, 0);
		// public static final PIDTester thetaControllTester = new
		// PIDTester(thetaController, "thetaController",
